//esto es para ejecutar acciones en relacion a las funcionalidades
//Deben ser en mayuscula por convencion

//importar en proyecto state y en reducer
export const FORMULARIO_PROYECTO = "FORMULARIO_PROYECTO";
//importar en proyecto state
